...
echo("<!DOCTYPE html><html><head><TITLE>BRSC VOLUNTEERING</TITLE>");
...
$filea=fopen("BRSC_VOLUNTEERS.csv","r") or die("Unable to Open File");
    ...
    while (!feof($filea)){
		...
		if (strcmp($a[0],$current_id)==0)  {
			if ($entry_count==0) echo("<tr><td><b>Name</td><td colspan='5'><b>Role</td></tr>");
			$entry_count=$entry_count+1;
			echo("<tr><td>".$a[4]." </td><td colspan='5'> ".$a[3]."</td></tr>");
			for ($j=1; $j<=7; $j++) 
