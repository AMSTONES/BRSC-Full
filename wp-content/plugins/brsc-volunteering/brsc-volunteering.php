          ...
          foreach ($result as $print) {
            echo "
              <tr>
                ...
                <td width='25%'><a href='admin.php?page=brsc-volunteering%2Fbrsc-volunteering.php&upt=$print->user_id'><button type='button'>UPDATE</button></a> <a href='admin.php?page=brsc-volunteering%2Fbrsc-volunteering.php&del=$print->user_id'><button type='button'>DELETE</button></a></td>
              </tr>
            ";
          }
        ?>
          ...
          <tbody>
            <form action='' method='post'>
              <tr>
                ...
                <td width='25%'><button id='uptsubmit' name='uptsubmit' type='submit'>UPDATE</button> <a href='admin.php?page=brsc-volunteering%2Fbrsc-volunteering.php'><button type='button'>CANCEL</button></a></td>
              </tr>
            </form>
          </tbody>
        </table>";
